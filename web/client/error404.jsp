<%-- 
    Document   : error404
    Created on : Sep 25, 2017, 9:51:07 AM
        ...
        <div id="top">
            <div class="container">
                <div class="col-md-6 offer" data-animate="fadeInDown">
                    <a href="#" class="btn btn-success btn-sm" data-animate-hover="pulse">Offer of the day</a>  <a href="#">Get flat 35% off on orders over $50!</a>
                </div>
            ...
            <div class="row" id="error-page">
                <div class="col-sm-6 col-sm-offset-3">
                    <div class="box">
                        ...
                        <h3 class="align-center">We are sorry - this page is not here anymore</h3>
                        <h4 class="text-muted align-center">Error 404 - Page not found</h4>

                        <p class="align-center">To continue please use the <strong>Search form</strong> or <strong>Menu</strong> above.</p>

                        <p class="buttons align-center"><a href="index.jsp" class="btn btn-primary"><i class="fa fa-home"></i> Go to Homepage</a>
                        </p>
                    </div>
                </div>
            </div>
