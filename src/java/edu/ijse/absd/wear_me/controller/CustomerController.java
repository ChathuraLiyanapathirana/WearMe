...
public class CustomerController {
    ...
    @ResponseBody
    public String customerRegister(@ModelAttribute("customer") CustomerModel customer) {
        customer.setIsActive(true);
        String registerCustomer = customerService.registerCustomer(customer);
        return "customer add ok";
    }
